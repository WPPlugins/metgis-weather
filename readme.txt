...
This plugin is based on professional weather data provided by MetGIS. Click [here](http://www.metgis.com/en/api-docs/#get-developer-key "Get API-Key") to get your free API Key.
